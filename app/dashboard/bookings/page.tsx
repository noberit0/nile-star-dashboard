  ...
  const DEMO_BOOKINGS: Booking[] = [
    {
      ...
      travelDate: new Date().toISOString(), boardingPoint: 'Kampala Bus Terminal', dropoffPoint: 'Arua Park',
      seatNumbers: [12, 13], numberOfSeats: 2, totalPrice: 85000, paymentStatus: 'completed', bookingStatus: 'confirmed', validated: false,
      qrCodeUrl: null, payment: { provider: 'MTN', transactionId: 'MTN-123456', status: 'completed', completedAt: new Date().toISOString() },
    ...
    },
    {
      ...
      travelDate: new Date().toISOString(), boardingPoint: 'Arua Park', dropoffPoint: 'Kampala Bus Terminal',
      seatNumbers: [5], numberOfSeats: 1, totalPrice: 45000, paymentStatus: 'completed', bookingStatus: 'confirmed', validated: true,
      qrCodeUrl: null, payment: { provider: 'Airtel', transactionId: 'AIR-789012', status: 'completed', completedAt: new Date(Date.now() - 3600000).toISOString() },
      expiresAt: new Date(Date.now() + 86400000).toISOString(), createdAt: new Date(Date.now() - 3600000).toISOString(),
    },
    {
      ...
      travelDate: new Date().toISOString(), boardingPoint: 'Kampala Bus Terminal', dropoffPoint: 'Arua Park',
      seatNumbers: [8, 9, 10], numberOfSeats: 3, totalPrice: 135000, paymentStatus: 'completed', bookingStatus: 'confirmed', validated: false,
      qrCodeUrl: null, payment: { provider: 'MTN', transactionId: 'MTN-345678', status: 'completed', completedAt: new Date(Date.now() - 7200000).toISOString() },
      expiresAt: new Date(Date.now() + 86400000).toISOString(), createdAt: new Date(Date.now() - 7200000).toISOString(),
    },
    {
      ...
      travelDate: new Date().toISOString(), boardingPoint: 'Arua Park', dropoffPoint: 'Kampala Bus Terminal',
      seatNumbers: [1, 2], numberOfSeats: 2, totalPrice: 90000, paymentStatus: 'completed', bookingStatus: 'confirmed', validated: false,
      qrCodeUrl: null, payment: { provider: 'MTN', transactionId: 'MTN-901234', status: 'completed', completedAt: new Date(Date.now() - 10800000).toISOString() },
      expiresAt: new Date(Date.now() + 86400000).toISOString(), createdAt: new Date(Date.now() - 10800000).toISOString(),
    },
  ];
